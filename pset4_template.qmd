...
#@Ella: I had to change the path a bit to get this to run. Adjust
#as needed for your own purposes yours was:
...
tx_geo_data_direct.plot(ax=ax, color="red", edgecolor="black", linewidth=0.5, label="Direct ZIPs")

#Plot the indirect ZIPs in yellow
tx_geo_data_indirect_only.plot(ax=ax, color="yellow", edgecolor="black", linewidth=0.5, label="Indirect ZIPs")
